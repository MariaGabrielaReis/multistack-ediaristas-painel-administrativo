...
from .views import register_housekeeper, list_housekeepers, edit_housekeeper, remove_housekeeper
...
urlpatterns = [
    ...
    path('remove_housekeeper/<int:housekeeper_id>', remove_housekeeper, name='remove_housekeeper')
]
